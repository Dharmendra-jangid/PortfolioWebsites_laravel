  ...
  <body>
    <div class="login-page">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form class="text-left form-validate" action="{{route('admins.authRegister')}}" method="POST" >
                    @csrf
                  ...
                  </form><small>Already have an account? </small><a href="{{route('admins.login')}}" class="signup">Login</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="copyrights text-center">
         <p >2018 &copy; Your company. Download From <a target="_blank"
