          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form  action="{{route('admins.authlogin')}}" class="form-validate" method="POST">
                    @csrf
                  ...
                  </form><a href="#" class="forgot-pass">Forgot Password?</a><br><small>Do not have an account? </small><a href="{{route('admins.register')}}" class="signup">Signup</a>
                </div>
              </div>
            </div>
          </div>
